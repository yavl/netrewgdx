// source: https://gist.github.com/mcgrew/11102418
...
var tilesizee = 1 // Set tile size here

func main() {
  tileSize := tilesizee;
  inputFile,_ := os.Open("terrain.png") // Set file name here
...
func match(img1, img2 image.Image) bool {
  for x := 0; x < tilesizee; x++ {
    for y := 0; y < tilesizee; y++ {
